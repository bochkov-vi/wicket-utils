 ...
 */
package com.bochkov.wicket.component.toast;
...
/**
 * A panel that displays {@link FeedbackMessage}s in a list view. The
...
public class ToastFeedbackPanel extends Panel implements IFeedback {
     ...
     */
    public final ToastFeedbackPanel setFilter(IFeedbackMessageFilter filter) {
     ...
     * @return FeedbackPanel this.
     */
    public final ToastFeedbackPanel setSortingComparator(Comparator<FeedbackMessage> sortingComparator) {
    ...
    protected Component newMessageDisplayComponent(String id, FeedbackMessage message) {
        ...
        label.setEscapeModelStrings(ToastFeedbackPanel.this.getEscapeModelStrings());
        return label;
    }
     ...
     * @param itemModel The model object of the item
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        response.render(OnDomReadyHeaderItem.forScript("$('.toast').toast('show')"));
    }
    ...
    private final class MessageListView extends ListView<FeedbackMessage> {
        ...
        protected IModel<FeedbackMessage> getListItemModel(
            ...
            return new IModel<FeedbackMessage>() {
                 ...
                 *
                 * @see org.apache.wicket.settings.ApplicationSettings#setFeedbackMessageCleanupFilter(IFeedbackMessageFilter)
                 */
                @Override
        ...
        protected void populateItem(final ListItem<FeedbackMessage> listItem) {
            listItem.add(new AttributeModifier("data-delay", delay));
        ...
        protected ListItem<FeedbackMessage> newItem(int index, IModel<FeedbackMessage> itemModel) {
            return ToastFeedbackPanel.this.newMessageItem(index, itemModel);
        }
    }
}
